...
- phishing（钓鱼邮件）：账号安全验证、邮箱升级验证、密码窃取、虚假系统通知、文件/附件诱导下载、快递通知诈骗
- finance（发票财务资产）：代开发票、增值税发票、做账报销、财务询价、虚假财务报告、货款采购诈骗
- adult_violence（色情暴力低俗）：色情网站推广、成人内容、AV视频、偷拍资源、裸聊约炮、暴力低俗内容
- academic（论文会议推广）：学术会议征稿、论文润色发表、期刊投稿、培训课程、学术讲座、学位认证
- commercial（商业博彩营销）：产品推广营销、展会搭建、招标采购、招聘广告、线上博彩、体育赌博、彩票投注
